...
# --- SECCIÓN 4: MOTOR DE RUTINAS DINÁMICAS (SIMULACIÓN DE NUBE) ---
# Se definen bloques de ejercicios diferentes para cada tipo de entrenamiento
nube_superior = [
    {"n": "Flexiones de Pecho", "s": 4, "r": "12", "d": "60s", "img": "https://images.unsplash.com/photo-1598971639058-fab3c03af452?w=400"},
    {"n": "Remo con Banda", "s": 4, "r": "15", "d": "60s", "img": "https://images.unsplash.com/photo-1605296867304-46d5465a13f1?w=400"},
    {"n": "Press Militar (Hombros)", "s": 3, "r": "10", "d": "90s", "img": "https://images.unsplash.com/photo-1532029837206-aba2b762a638?w=400"},
    {"n": "Fondos en Silla", "s": 3, "r": "12", "d": "45s", "img": "https://images.unsplash.com/photo-1581009146145-b5ef03a74e7f?w=400"}
]

nube_inferior = [
    {"n": "Sentadillas Goblet", "s": 4, "r": "12", "d": "90s", "img": "https://images.unsplash.com/photo-1574680096145-d05b474e2155?w=400"},
    {"n": "Zancadas (Lunges)", "s": 3, "r": "12 por pierna", "d": "60s", "img": "https://images.unsplash.com/photo-1591741535018-d042766c62eb?w=400"},
...
nube_fisioterapia = [
    ...
    {"n": "Plancha sobre Rodillas", "s": 3, "r": "30 seg", "d": "60s", "img": "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400"}
]

st.header(f"🏋️ Planificación Semanal para {alias}")

# Algoritmo de distribución de carga por día
